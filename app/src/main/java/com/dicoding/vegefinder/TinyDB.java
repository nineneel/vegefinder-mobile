...
public class TinyDB {
    ...
    public ArrayList<Vegetable> getVegetableList(String key){
        ...
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Vegetable> objects =  new ArrayList<Vegetable>();

        for(String jObjString : objStrings){
            Vegetable value  = gson.fromJson(jObjString,  Vegetable.class);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<VegetableType> getVegetableTypeList(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<VegetableType> objects =  new ArrayList<VegetableType>();
     ...
     * @param obj is the Object you want to put
     */
    public void putVegetable(String key, Vegetable obj){
        checkForNullKey(key);
        Gson gson = new Gson();
        putString(key, gson.toJson(obj));
    }

    public void putListVegetable(String key, ArrayList<Vegetable> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){

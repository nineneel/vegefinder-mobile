...
import com.dicoding.vegefinder.viewmodel.JenisViewModel
...
//    )
    ...
    private lateinit var jenisViewModel: JenisViewModel
    ...
    override fun onCreateView(
        ...
        jenisAdapter = JenisAdapter(requireContext())
        ...
        recyclerViewJenis.adapter = jenisAdapter

        jenisViewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory())[JenisViewModel::class.java]

        jenisViewModel.setJenis()
        jenisViewModel.getJenisResponse().observe(viewLifecycleOwner){listJenis ->
//            listJenis?.let{
//                jenisAdapter.setList(listJenis)
//            }

...
import com.bangkit.vegefinder.adapter.ImageSlideAdapter
import com.bangkit.vegefinder.adapter.TypeTagAdapter
import com.bangkit.vegefinder.helper.ToastDisplay
import com.bangkit.vegefinder.helper.getScreenHeight
import com.bangkit.vegefinder.viewmodel.SaveVegetableViewModel
...
class VegetableActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (probabilities != null) {
            ...
            fromPredictionTextView.text =
                "Success, with ${(probabilities.substring(0, 5))}% probabilities"
        }

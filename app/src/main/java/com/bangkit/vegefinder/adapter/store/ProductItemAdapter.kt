...
class ProductItemAdapter(private val productList: List<Product>, private val context: Context) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val imageView: ImageView = itemView.findViewById(R.id.str_image)
        private val nameTextView: TextView = itemView.findViewById(R.id.str_name)
        private val priceTextView: TextView = itemView.findViewById(R.id.str_price)
        ...
        override fun onClick(view: View) {
            ...
            intent.putExtra("image", productList[adapterPosition].image)
